# -*- encoding: utf-8 -*-
# stub: elasticsearch 8.2.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<elastic-transport>.freeze, ["~> 8.0"])
    s.add_runtime_dependency(%q<elasticsearch-api>.freeze, ["= 8.2.2"])
    ...
    s.add_dependency(%q<elastic-transport>.freeze, ["~> 8.0"])
    s.add_dependency(%q<elasticsearch-api>.freeze, ["= 8.2.2"])
